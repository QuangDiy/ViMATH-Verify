...
gold = parse("Ta có phương trình chuyển động của vật rơi tự do với vận tốc ban đầu $v_0$ là: $s = v_0t + \frac{1}{2}gt^2$. Theo đề bài, vật rơi với vận tốc ban đầu $v_0 = 12$ m/s, gia tốc trọng trường $g = 9,8$ m/s² và thời gian rơi là $t = 7$ s. Thay các giá trị này vào phương trình, ta có: $s = (12)(7) + \frac{1}{2}(9,8)(7^2)$, $s = 84 + \frac{1}{2}(9,8)(49)$, $s = 84 + (4,9)(49)$, $s = 84 + 240,1$, $s = 324,1$ m. Đáp án đúng là A.", extraction_config=[StringExtractionConfig()])
answer = parse("-0,626", extraction_config=[ExprExtractionConfig(), LatexExtractionConfig()])
